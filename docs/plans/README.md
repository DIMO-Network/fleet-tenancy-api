...
| Plan | Status |
|---|---|
| [01-groups-into-tenancy.md](01-groups-into-tenancy.md) | **Done 2026-08-21** — P5b shipped: integrity rules live (`v0.21.0`), local tables dropped in both apps (fleet-lite `v0.21.0`, kaufmann `v1.54.0`), flags, mirrors and diff crons deleted |
...
| [08-aa-owner-signing.md](08-aa-owner-signing.md) | **Steps 1–4 RELEASED 2026-09-01** — this repo `v0.29.0` (#83, migration `20260831120000` applied, owner mode configured at boot), kaufmann `v1.57.0` (#228), b2b `v1.14.0` (#187), fleet-lite `v0.30.0` (#152); routes probed live, logs clean. Sponsorship: secrets deliberately left as-is, no policy limits (user research). **Next: step 5, the first live exercise — needs a console session** (runbook at the end of HANDOFF.md); then steps 6–7 |
