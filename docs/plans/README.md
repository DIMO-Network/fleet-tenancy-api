...
| [08-aa-owner-signing.md](08-aa-owner-signing.md) | **Steps 1–2 built 2026-08-31** (#83, not merged) — credential + config surface with strict on-chain validation, owner mode in the sharing engine (rides the sharing config, one ZeroDev project for both paths; the per-tenant wallet row is the switch; all pre-flights resolved). Next: step 3, the kaufmann proxy + b2b console |
