...
| [08-aa-owner-signing.md](08-aa-owner-signing.md) | **Steps 1–2 built 2026-08-31** (#83, not merged) — credential + config surface with strict on-chain validation, owner mode in the sharing engine behind `AA_BUNDLER_URL` (ships dark; all pre-flights resolved, sponsoring project confirmed). Next: step 3, the kaufmann proxy + b2b console |
