...
| [08-aa-owner-signing.md](08-aa-owner-signing.md) | **Step 1 built 2026-08-31** (#83, not merged) — migration `20260831120000`, config endpoints with strict on-chain validation, `AAWalletSigner` decrypt path; step 2 (owner mode in the sharing engine) next. Validator getter verified on chain; paymaster-policy pre-flight still open |
