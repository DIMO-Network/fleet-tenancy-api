module github.com/DIMO-Network/fleet-tenancy-api

go 1.26.0

require (
	github.com/DIMO-Network/cloudevent v0.1.6
	github.com/DIMO-Network/go-transactions v0.4.0
	github.com/DIMO-Network/go-zerodev v0.5.1-0.20260513203230-cd16aeb5188a
